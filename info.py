...
PAYMENT_ID = environ.get('PAYMENT_ID', '@kog_shuvo') # payment code picture url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/movie_group_02') # Support Chat Link Without https:// or @
